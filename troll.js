...
var dareCorrect = [
  ...
  "Choose a girl. She has to act like a dog for the rest of the game",
]

var dareWrong = [
  "Do 10 pushups",
  "Act like a cat for the rest of the game",
  "Act like a dog for the rest of the game",
  "Call a fast-food place and ask them for pizza",
  "Call a fast-food place and ask if they are open",
  "Call a pizza place and ask for fast-food",
  "Call a pizza place and ask if they are open",
...
function getNewQuestion(){
  if(availableQuestions.length == 0 ||  questionCounter >= maxQuestions){
    ...
    return window.location.assign("./endTroll.html");
  }
  questionCounter++;
